...
export function ProjectManager() {
    ...
    async function handleDelete(projectId: string, projectName: string) {
        if (
            !confirm(
                `Are you sure you want to delete "${projectName}"? This will delete all its sources and reports.`,
            )
        )
            return;
                            ...
                            {activeProject ? (
                                <div className="flex items-center gap-3 bg-muted/50 p-3 rounded-md">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground font-mono truncate w-32">
                                            {activeProject.id}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    No active project selected. Create one
                                    below.
                                </p>
                            )}
                        </CardContent>
                    ...
                    <Card className="h-full">
                        <CardHeader className="pb-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <SelectTrigger className="h-8 w-[140px] bg-background text-sm shadow-sm">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                    ...
                                    {filteredProjects.map((project) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                {renamingId !== project.id && (
                                                    <div
                                                        className="absolute top-3 right-3 flex gap-1 opacity-0 group-hover:opacity-100 hover-opacity-override"
                                                        onClick={(e) =>
                                                            e.stopPropagation()
                                                        }
                                                    >
