...
const quickLinks = [
    ...
    },
    {
        ...
        label: "Jobs",
        description:
            "Track queue progress, inspect failures, and retry or cancel.",
        icon: ListChecks,
    ...
    },
    {
        ...
        label: "Settings",
        description:
            "Attach OpenAI, Gemini, and future provider keys per project",
        icon: Sparkles,
        color: "text-cyan-500",
        bg: "bg-cyan-500/10",
    },
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-border p-8">
                <div className="relative z-10 flex flex-col gap-3 max-w-xl">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        Your AI research infrastructure. Create a project,
                        ingest documents, then query your knowledge base with
                        natural language.
                    </p>
                </div>
                {/* Decorative */}
